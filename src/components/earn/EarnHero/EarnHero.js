    ...
    <div className="row w-100 earn-hero p-4 justify-content-between">
        ...
        <div className="col-6 d-flex gap-5">
         ...
         <p style={{fontSize: '9px', color: '#F36D46', fontWeight: '300'}}>Rewards paid out</p>
            <CountUp
                      style={{fontSize: '19px', color: '#F36D46', fontWeight: '600', textAlign: 'start'}}
          ...
          <div className="d-flex flex-column justify-content-between">
            <div className="d-flex justify-content-start align-items-center gap-2">
              <img src={eth} alt="" />
              <h4 style={{color: '#6C85E7'}}> {getFormattedNumber(
            ...
            <div className="d-flex justify-content-start align-items-center gap-2">
              <img src={bnb} alt="" />
              <h4 style={{color: '#F6CC29'}}>{getFormattedNumber(
            ...
            <div className="d-flex justify-content-start align-items-center gap-2">
              <img src={avax} alt="" />
              <h4 style={{color: '#F86667'}}>{getFormattedNumber(
