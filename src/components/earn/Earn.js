...
const Earn = ({coinbase, the_graph_result, lp_id, isConnected, network}) => {
  ...
  return (
    <div className="container-lg earn-wrapper d-flex flex-column justify-content-center align-items-center py-3 position-relative">
      <EarnHero />
      <EarnContent coinbase = {coinbase} the_graph_result = {the_graph_result} lp_id = {lp_id} isConnected = {isConnected} chainId={network}/>
      <EarnFaq />
