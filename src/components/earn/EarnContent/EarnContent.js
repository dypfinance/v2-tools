  ...
  return (
    <>
        ...
        <div className="col-2 d-flex justify-content-start align-items-center gap-3">
            <div className={`list-style ${listStyle === 'table' && 'list-style-active'}`} onClick={() => setListStyle('table')}>
                <img src={listStyle === 'table' ? tableIconActive : tableIcon} alt="" />
            </div>
            <div className={`list-style ${listStyle === 'list' && 'list-style-active'}`} onClick={() => setListStyle('list')}>
                <img src={listStyle === 'list' ? listIconActive : listIcon} alt="" />
            </div>
        </div>
        <div className="col-8 d-flex gap-3 justify-content-center">
            ...
            <div className={`stake-item position-relative d-flex align-items-center gap-2 ${stake === "bnb" ? 'stake-item-active': null}`} onClick={() => setStake('bnb')}>
                <div className="new-pools d-flex justify-content-start align-items-center gap-2 position-absolute">
                    <img src={addNewPools} alt="" style={{width: '15px', height: '15px'}} />
                    <span className='text-white' style={{fontSize: '11px'}}>New Pools</span>
                </div>
            ...
            <div className={`stake-item position-relative d-flex align-items-center gap-2 ${stake === "avax" ? 'stake-item-active': null}`} onClick={() => setStake('avax')}>
            <div className="new-pools d-flex justify-content-start align-items-center gap-2 position-absolute">
                    <img src={addNewPools} alt="" style={{width: '15px', height: '15px'}} />
                    <span className='text-white' style={{fontSize: '11px'}}>New Pools</span>
                </div>
