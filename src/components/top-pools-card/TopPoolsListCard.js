...
const TopPoolsListCard = ({
  ...
  return (
    <> <div className="row w-100 d-flex flex-row align-items-center justify-content-between list-pool-card mx-0 cursor-pointer" onClick={() => handleDetails()}>
    <div className={`col-2 d-flex align-items-center ${cardType === 'Farming' || cardType === 'Buyback' ? null : 'gap-2'}`} style={{width: '100px'}}>
    ...
    <div className="col-2 d-flex justify-content-end" style={{width: '170px'}}>
    {top_pick &&
    <img src={topPick} alt="" />
    }
    <h6
