...
const PoolsCalculator = ({onClose}) => {
  return (
    ...
    <div className="d-flex align-items-center justify-content-between">
        ...
        <h5 style={{fontSize: '23px', fontWeight: '500', color: '#f7f7fc' }}>Calculator</h5>
        </div>
    ...
    <div className="d-flex align-items-center justify-content-between">
       ...
       <span style={{fontSize: '15px', fontWeight: '500'}}>Days to stake</span>
        <input
        style={{height: '40px'}}
                type="number"
       ...
       <div className='d-flex flex-column gap-3 w-50 me-5'>
       <span style={{fontSize: '15px', fontWeight: '500'}}>Amount to stake</span>
        <input
        style={{height: '40px'}}
                type="number"
                className="form-control calcinput w-100"
    ...
    <div className="d-flex flex-column gap-2 mt-4">
        ...
        <h6 style={{fontWeight: '300', fontSize: '15px', color: '#f7f7fc'}}>Approx (1.351085WETH)</h6>
    </div>
    <div className="mt-4">
        <p style={{fontWeight: '400', fontSize: '13px', color: '#f7f7fc'}}>
        *This calculator is for informational purposes only.
Calculated yields assume that prices of the deposited assets don't change. 
        </p>
    </div>
    </div>
  )
