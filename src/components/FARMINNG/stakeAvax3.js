...
export default function stakeAva3({
  ...
  class StakeAvax3 extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        token_balance: "",
    ...
    this.setState({ claimStatus: "claim" });
      ...
      staking.claim(0, _amountOutMin, deadline).then(() => {
    ...
    this.setState({ reInvestStatus: "invest", reInvestLoading: true });
      ...
      staking.reInvest(0, 0, deadline).then(() => {
    ...
    render() {
      ...
      return (
        ...
        //             </p>
        //             <p>
        //               Stake your DYP tokens and earn 25% APR in AVAX with no
        //               Impermanent Loss.
        //             </p>
        //             <p>
        //               To start earning, all you need is to deposit DYP tokens
        //               into the Staking contract and earn AVAX as rewards.
        //             </p>
        //             <p>
