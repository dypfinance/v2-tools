...
export default function initBscBuyback({
  staking,
  constant,
  apr,
  lock,
  ...
  class BscBuyback extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        token_balance: "",
    ...
    componentDidMount() {
      ...
      this.getConstantWithdrawDyp();

      this.getStakeWithdrawDyp();
    ...
    getConstantWithdrawDyp = async () => {
      let amountConstant = await constant.depositedTokens(this.state.coinbase);
      amountConstant = new BigNumber(amountConstant).toFixed(0);
      this.setState({ dypConstWithdraw: amountConstant });
    };
    ...
    getDypbalanceConst = async () => {
      ...
      this.setState({ dypConst: _amountOutMinConstant });
      try {
    ...
    getDypbalanceStake = async () => {
      ...
      _amountOutMin = new BigNumber(_amountOutMin)
        ...
        .div(100)
        .toFixed(0);
      this.setState({ dypstake: _amountOutMin });
    };

    handleClaimDypStake = async () => {
    ...
    render() {
      ...
      return (
                    ...
                    <div className="d-flex flex-column gap-1">
                      ...
                      <div className="d-flex flex-column align-items-startar justify-content-between gap-2">
                        <button
                          ...
                          onClick={() =>
                            this.state.selectedPool === "idyp2"
                              ? this.handleStakeWithdraw()
                              : this.state.selectedPool === "dyp2"
                              ? this.handleConstantWithdraw()
                              : console.log("")
                          }
                        >
                          {this.state.withdrawLoading ? (
        ...
        //             </p>
        //             <p>
        //               Deposit WBNB, BTCB, ETH, BUSD, or CAKE, and earn{" "}
        //               {this.state.apyBuyback2 == 0
        //                 ? "..."
        //                 : getFormattedNumber(this.state.apyBuyback2, 0)}
        //               % APR in DYP. To start earning, all you need is to deposit
        //               one of the supported assets into the Buyback contract.
        //               Then, all assets will automatically be converted into DYP
        //               + iDYP and deposited into a staking contract. You can
        //               choose from two different options, with rewards starting
        //               from{" "}
        ...
        //               claimed every day. When you unstake you will receive all
        //               the deposited amounts in DYP.
        //             </p>
        //           </div>
        //         </Modal>
        //         <Modal
        ...
        //                   onClick={() =>
        //                     window.open(
        //                       "https://www.youtube.com/watch?v=l3Jka88T308",
        //                       "_blank"
        //                     )
        //                   }
        ...
        //                       className="mt-1 text-center mb-0 text-muted mt-3"
        //                     >
        //                       To <strong>WITHDRAW</strong> you will be asked to
        //                       sign <strong>2 transactions</strong>
        //                     </p>
        //                     <p
        //                       style={{ fontSize: ".8rem" }}
        ...
        //                       className="mt-1 text-center mb-0 text-muted mt-3"
        //                     >
        //                       To <strong>CLAIM</strong> you will be asked to
        //                       sign <strong>2 transactions</strong>
        //                     </p>
        //                   </form>
        //                 </div>
